...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8/90 lg:background-blur-sm ${openNavigation ? "bg-n-8" : "bg-n-8/50"}`}
    >
...
lg:leading-5 lg:hover:text-n-1 xl:px-12`}
        ...
        <Button className="hidden lg:flex" href="#login" white={""} px={""}>
          Sign in
        </Button>
